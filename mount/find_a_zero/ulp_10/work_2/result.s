...
.find_a_zero:                 #        0x400790  0      OPC=<label>               
  ...
  movdqa %xmm12, %xmm5        #  4     0x40079f  5      OPC=movdqa_xmm_xmm_1      
  ja .L_400918                #  5     0x4007a4  6      OPC=ja_label_1            
.L_4007a9:                    #        0x4007aa  0      OPC=<label>               
  movsd 0x25e(%rip), %xmm0    #  6     0x4007aa  8      OPC=movsd_xmm_m64         
  vmovq %xmm9, %xmm7          #  7     0x4007b2  5      OPC=vmovq_xmm_xmm         
  ucomisd %xmm5, %xmm4        #  8     0x4007b7  4      OPC=ucomisd_xmm_xmm       
  ja .L_400910                #  9     0x4007bb  6      OPC=ja_label_1            
  vmovq %xmm3, %xmm8          #  10    0x4007c1  5      OPC=vmovq_xmm_xmm_1       
  vpmovzxwd %xmm9, %xmm11     #  11    0x4007c6  5      OPC=vpmovzxwd_xmm_xmm     
  vmovq 0x1fc(%rip), %xmm10   #  12    0x4007cb  9      OPC=vmovq_xmm_m64         
...
.L_40082e:                    #        0x4007e4  0      OPC=<label>               
  ...
  vmovdqa %xmm7, %xmm6        #  17    0x4007e9  4      OPC=vmovdqa_xmm_xmm_1     
  mulsd %xmm7, %xmm6          #  18    0x4007ed  4      OPC=mulsd_xmm_xmm         
  vmovq %xmm6, %xmm5          #  19    0x4007f1  4      OPC=vmovq_xmm_xmm         
  mulpd %xmm1, %xmm6          #  20    0x4007f5  4      OPC=mulpd_xmm_xmm         
  addsd %xmm6, %xmm3          #  21    0x4007f9  4      OPC=addsd_xmm_xmm         
  mulsd %xmm7, %xmm5          #  22    0x4007fd  4      OPC=mulsd_xmm_xmm         
  movdqa %xmm2, %xmm6         #  23    0x400801  4      OPC=movdqa_xmm_xmm        
  mulsd %xmm7, %xmm6          #  24    0x400805  4      OPC=mulsd_xmm_xmm         
  mulsd %xmm12, %xmm5         #  25    0x400809  5      OPC=mulsd_xmm_xmm         
  addsd %xmm3, %xmm5          #  26    0x40080e  4      OPC=addsd_xmm_xmm         
  addsd %xmm6, %xmm5          #  27    0x400812  4      OPC=addsd_xmm_xmm         
  vpbroadcastq %xmm5, %xmm6   #  28    0x400816  5      OPC=vpbroadcastq_xmm_xmm  
  vcomisd %xmm5, %xmm9        #  29    0x40081b  4      OPC=vcomisd_xmm_xmm       
  movlps 0x1fa(%rip), %xmm0   #  30    0x40081f  7      OPC=movlps_xmm_m64        
  movlps 0x1ca(%rip), %xmm13  #  31    0x400826  8      OPC=movlps_xmm_m64        
  ja .L_4008c8                #  32    0x40082e  2      OPC=ja_label              
  vucomisd %xmm5, %xmm4       #  33    0x400830  4      OPC=vucomisd_xmm_xmm      
  ja .L_4008d2                #  34    0x400834  2      OPC=ja_label              
.L_400871:                    #        0x400836  0      OPC=<label>               
  ucomisd %xmm9, %xmm8        #  35    0x400836  5      OPC=ucomisd_xmm_xmm       
  jb .L_40087f                #  36    0x40083b  2      OPC=jb_label              
  vcomisd %xmm5, %xmm11       #  37    0x40083d  4      OPC=vcomisd_xmm_xmm       
...
.L_4008b7:                    #        0x40086a  0      OPC=<label>               
  mulpd %xmm13, %xmm10        #  49    0x40086a  5      OPC=mulpd_xmm_xmm         
  jmpq .L_400829              #  50    0x40086f  5      OPC=jmpq_label_1          
.L_4008c8:                    #        0x400874  0      OPC=<label>               
  pxor %xmm0, %xmm6           #  51    0x400874  4      OPC=pxor_xmm_xmm          
  vcomisd %xmm6, %xmm4        #  52    0x400878  4      OPC=vcomisd_xmm_xmm       
  jbe .L_400871               #  53    0x40087c  2      OPC=jbe_label             
.L_4008d2:                    #        0x40087e  0      OPC=<label>               
  movapd %xmm7, %xmm0         #  54    0x40087e  4      OPC=movapd_xmm_xmm        
...
.L_400918:                    #        0x40088f  0      OPC=<label>               
  vmovq 0x188(%rip), %xmm5    #  61    0x40088f  9      OPC=vmovq_xmm_m64         
  xorpd %xmm0, %xmm5          #  62    0x400898  4      OPC=xorpd_xmm_xmm         
